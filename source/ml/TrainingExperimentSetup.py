...
class ExperimentSetup:
    ...
    def memeticExperimentalPlacement7(self, num_creatures, num_generations, iteration, dataset_size):
        ...
        best_solution, solutions = memetic_experimental7(num_creatures, num_generations, services_requirements,
                                                         hosts_resources,
    ...
    def memeticExperimentalPlacement8(self, num_creatures, num_generations, iteration, dataset_size):
        ...
        best_solution, solutions = memetic_experimental8(num_creatures, num_generations, services_requirements,
                                                         hosts_resources,
                                                         self.MAX_PRIORITY, self.DISTANCE_TO_CLOUD)
